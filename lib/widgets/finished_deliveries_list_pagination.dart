...
class FinishedDeliveriesListPagination extends StatefulWidget {
  List data;
  int currentPage;
  FinishedDeliveriesListPagination(this.data, this.currentPage);

  @override
  _FinishedDeliveriesListPaginationState createState() => _FinishedDeliveriesListPaginationState();
}

class _FinishedDeliveriesListPaginationState extends State<FinishedDeliveriesListPagination> {
  ...
  _scrollListener() async {
    try {
      if (_controller.offset >= _controller.position.maxScrollExtent &&
        ...
        List temp =
        await Provider.of<FinishedDeliveriesAPIService>(context, listen: false)
            .fetchFinishedDeliveriesPagination(widget.currentPage + 1, Constants.myToken);
